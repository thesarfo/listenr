  ...
  return (
    ...
    >
      ...
      <div className="p-4 md:p-3">
        <button 
          onClick={onLog}
          className="w-full bg-primary hover:bg-primary/90 text-background-dark font-bold py-4 md:py-3 rounded-xl md:rounded-lg text-base md:text-sm transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/10 active:scale-95 touch-manipulation"
        >
